defmodule Capstone.Vendor.Vex.ErrorRenderer do
  @moduledoc """
  ...
  Result of `message` function appears in `Capstone.Vendor.Vex.errors` error tuple as last element, for those
  validators who use `Capstone.Vendor.Vex.Validator.ErrorMessage` (in general they should).
  """
