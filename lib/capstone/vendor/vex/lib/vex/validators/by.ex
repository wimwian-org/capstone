defmodule Capstone.Vendor.Vex.Validators.By do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Capstone.Vendor.Vex.Validators.By.validate(2, &(&1 == 2))
      :ok
      iex> Capstone.Vendor.Vex.Validators.By.validate(3, &(&1 == 2))
      {:error, "must be valid"}
      iex> Capstone.Vendor.Vex.Validators.By.validate(["foo", "foo"], &is_list/1)
      :ok
      iex> Capstone.Vendor.Vex.Validators.By.validate("sgge", fn (word) -> word |> String.reverse == "eggs" end)
      :ok
      iex> Capstone.Vendor.Vex.Validators.By.validate(nil, [function: &is_list/1, allow_nil: true])
      :ok
      iex> Capstone.Vendor.Vex.Validators.By.validate({}, [function: &is_list/1, allow_blank: true])
      :ok
      iex> Capstone.Vendor.Vex.Validators.By.validate([1], [function: &is_list/1, message: "must be a list"])
      :ok
      iex> Capstone.Vendor.Vex.Validators.By.validate("a", [function: &is_list/1, message: "must be a list"])
      {:error, "must be a list"}

      iex> Capstone.Vendor.Vex.Validators.By.validate(
  ...
  Custom error messages (in EEx format), provided as :message, can use the following values:
      ...
      iex> Capstone.Vendor.Vex.Validators.By.__validator__(:message_fields)
      [value: "The bad value"]

  An example:

      iex> Capstone.Vendor.Vex.Validators.By.validate("blah", [function: &is_list/1, message: "<%= inspect value %> isn't a list"])
