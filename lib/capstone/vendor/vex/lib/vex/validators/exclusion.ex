defmodule Capstone.Vendor.Vex.Validators.Exclusion do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Capstone.Vendor.Vex.Validators.Exclusion.validate(1, [1, 2, 3])
      {:error, "must not be one of [1, 2, 3]"}
      iex> Capstone.Vendor.Vex.Validators.Exclusion.validate(1, [in: [1, 2, 3]])
      {:error, "must not be one of [1, 2, 3]"}
      iex> Capstone.Vendor.Vex.Validators.Exclusion.validate(1, [in: [1, 2, 3], message: "<%= value %> shouldn't be in <%= inspect list %>"])
      {:error, "1 shouldn't be in [1, 2, 3]"}
      iex> Capstone.Vendor.Vex.Validators.Exclusion.validate(4, [1, 2, 3])
      :ok
      iex> Capstone.Vendor.Vex.Validators.Exclusion.validate("a", ~w(a b c))
      {:error, ~S(must not be one of ["a", "b", "c"])}
      iex> Capstone.Vendor.Vex.Validators.Exclusion.validate("a", in: ~w(a b c), message: "must not be abc, talkin' 'bout 123")
  ...
  Custom error messages (in EEx format), provided as :message, can use the following values:
      ...
      iex> Capstone.Vendor.Vex.Validators.Exclusion.__validator__(:message_fields)
      [value: "The bad value", list: "List"]

  An example:

      iex> Capstone.Vendor.Vex.Validators.Exclusion.validate("a", in: ~w(a b c), message: "<%= inspect value %> is a disallowed value")
