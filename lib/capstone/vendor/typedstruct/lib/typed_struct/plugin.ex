defmodule Capstone.Vendor.TypedStruct.Plugin do
  @moduledoc """
  ...
  own needs with Capstone.Vendor.TypedStruct.

  ## Plugin definition

  A Capstone.Vendor.TypedStruct plugin is a module that implements `Capstone.Vendor.TypedStruct.Plugin`. Three
  callbacks are available to you for injecting code at different steps:

    * `c:init/1` lets you inject code where the `Capstone.Vendor.TypedStruct.plugin/2` macro is
      called,
  ...
  used this way:
      ...
      defmodule MyStruct do
        use Capstone.Vendor.TypedStruct
  ...
  Follows the plugin definition:
      ...
      defmodule DescribedStruct do
        use Capstone.Vendor.TypedStruct.Plugin
        ...
        # `Capstone.Vendor.TypedStruct.field/3` call.
        @impl true
  ...
  @doc """
  Injects code where `Capstone.Vendor.TypedStruct.plugin/2` is called.
  """
  @macrocallback init(opts :: keyword()) :: Macro.t()

  @doc deprecated: "Use Capstone.Vendor.TypedStruct.Plugin.field/4 instead"
  ...
  `name` and `type` are the exact values passed to the `Capstone.Vendor.TypedStruct.field/3`
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour Capstone.Vendor.TypedStruct.Plugin
