...
defmodule Capstone.Vendor.Sourceror.Code.Module do
  @moduledoc "Utilities for working with Elixir modules"
  require Capstone.Vendor.Sourceror.Code.Common
  alias Capstone.Vendor.Sourceror.Code.Common
  ...
  ## Examples
      ...
      iex> {:ok, result} = Capstone.Vendor.Sourceror.Code.Module.move_to_defmodule(zipper)
  ...
  def move_to_defmodule(zipper) do
    Capstone.Vendor.Sourceror.Code.Function.move_to_function_call_in_current_scope(zipper, :defmodule, 2)
  end
  ...
  ## Examples
      ...
      iex> zipper = Capstone.Vendor.Sourceror.parse_string!("defmodule Foo do\\nend") |> Capstone.Vendor.Sourceror.Zipper.zip()
      iex> {:ok, result} = Capstone.Vendor.Sourceror.Code.Module.move_to_defmodule(zipper, Foo)
      iex> match?({:defmodule, _, _}, result.node)
      true
  ...
  def move_to_defmodule(zipper, module) do
    Capstone.Vendor.Sourceror.Code.Function.move_to_function_call(
      zipper,
      :defmodule,
      2,
      fn zipper ->
        case Capstone.Vendor.Sourceror.Code.Function.move_to_nth_argument(zipper, 0) do
          {:ok, zipper} ->
            Capstone.Vendor.Sourceror.Code.Common.nodes_equal?(zipper, module)
  ...
  ## Examples
      ...
      iex> zipper = Capstone.Vendor.Sourceror.parse_string!("defmodule Foo do\\n  use Bar\\nend") |> Capstone.Vendor.Sourceror.Zipper.zip()
      iex> {:ok, result} = Capstone.Vendor.Sourceror.Code.Module.move_to_module_using(zipper, Bar)
      iex> match?({:defmodule, _, _}, result.node)
      true
  ...
  def move_to_module_using(zipper, module) do
    with {:ok, mod_zipper} <- move_to_defmodule(zipper),
         {:ok, mod_zipper} <- Capstone.Vendor.Sourceror.Code.Common.move_to_do_block(mod_zipper),
  ...
  ## Examples
      ...
      iex> zipper = Capstone.Vendor.Sourceror.parse_string!("defmodule Foo do\\n  use Bar\\nend") |> Capstone.Vendor.Sourceror.Zipper.zip()
      iex> {:ok, mod} = Capstone.Vendor.Sourceror.Code.Module.move_to_defmodule(zipper)
      iex> {:ok, body} = Capstone.Vendor.Sourceror.Code.Common.move_to_do_block(mod)
      iex> {:ok, result} = Capstone.Vendor.Sourceror.Code.Module.move_to_use(body, Bar)
  ...
  def move_to_use(zipper, module) do
    Capstone.Vendor.Sourceror.Code.Function.move_to_function_call_in_current_scope(
      zipper,
      :use,
      [1, 2],
      fn call ->
        Capstone.Vendor.Sourceror.Code.Function.argument_matches_predicate?(
          call,
          0,
          &Capstone.Vendor.Sourceror.Code.Common.nodes_equal?(&1, module)
        )
      end
    )
  end
  ...
  You can move into `@doc` attribute with:
      ...
      Capstone.Vendor.Sourceror.Code.Module.move_to_attribute_definition(zipper, :doc)

  Or you can move into `@session_options` constant with:

      Capstone.Vendor.Sourceror.Code.Module.move_to_attribute_definition(zipper, :session_options)

  ## Examples

      iex> zipper = Capstone.Vendor.Sourceror.parse_string!("defmodule Foo do\\n  @doc \\"Hello\\"\\nend") |> Capstone.Vendor.Sourceror.Zipper.zip()
      iex> {:ok, result} = Capstone.Vendor.Sourceror.Code.Module.move_to_attribute_definition(zipper, :doc)
  ...
  def move_to_attribute_definition(zipper, name) when is_atom(name) do
    with {:ok, zipper} <- Capstone.Vendor.Sourceror.Code.Module.move_to_defmodule(zipper),
  ...
  ## Examples
      ...
      iex> zipper = Capstone.Vendor.Sourceror.parse_string!("Foo.Bar") |> Capstone.Vendor.Sourceror.Zipper.zip()
      iex> Capstone.Vendor.Sourceror.Code.Module.module?(zipper)
      true
  ...
  ## Examples
      ...
      iex> zipper = Capstone.Vendor.Sourceror.parse_string!("Foo.Bar") |> Capstone.Vendor.Sourceror.Zipper.zip()
      iex> Capstone.Vendor.Sourceror.Code.Module.module_matching?(zipper, fn mod -> mod == Foo.Bar end)
      true
  """
  def module_matching?(zipper, pred) do
    zipper =
      zipper
      |> Capstone.Vendor.Sourceror.Code.Common.maybe_move_to_single_child_block()
