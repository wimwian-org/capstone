defmodule Capstone.Vendor.Sourceror.Identifier do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> "node()" |> Capstone.Vendor.Sourceror.parse_string!() |> is_call()
      true

      iex> "Kernel.node()" |> Capstone.Vendor.Sourceror.parse_string!() |> is_call()
      true

      iex> "%{}" |> Capstone.Vendor.Sourceror.parse_string!() |> is_call()
      true

      iex> "@attr" |> Capstone.Vendor.Sourceror.parse_string!() |> is_call()
      true

      iex> "node" |> Capstone.Vendor.Sourceror.parse_string!() |> is_call()
      false

      iex> "1" |> Capstone.Vendor.Sourceror.parse_string!() |> is_call()
      false

      iex> "(1; 2)" |> Capstone.Vendor.Sourceror.parse_string!() |> is_call()
      false

      iex> "Macro.Env" |> Capstone.Vendor.Sourceror.parse_string!() |> is_call()
      false
  """
  ...
  ## Examples
      ...
      iex> "node()" |> Capstone.Vendor.Sourceror.parse_string!() |> is_unqualified_call()
      true

      iex> "%{}" |> Capstone.Vendor.Sourceror.parse_string!() |> is_unqualified_call()
      true

      iex> "@attr" |> Capstone.Vendor.Sourceror.parse_string!() |> is_unqualified_call()
      true

      iex> "node" |> Capstone.Vendor.Sourceror.parse_string!() |> is_unqualified_call()
      false

      iex> "1" |> Capstone.Vendor.Sourceror.parse_string!() |> is_unqualified_call()
      false

      iex> "(1; 2)" |> Capstone.Vendor.Sourceror.parse_string!() |> is_unqualified_call()
      false

      iex> "Macro.Env" |> Capstone.Vendor.Sourceror.parse_string!() |> is_unqualified_call()
      false
  """
  ...
  ## Examples
      ...
      iex> "Kernel.node()" |> Capstone.Vendor.Sourceror.parse_string!() |> is_qualified_call()
      true

      iex> "__MODULE__.node()" |> Capstone.Vendor.Sourceror.parse_string!() |> is_qualified_call()
      true

      iex> "foo.()" |> Capstone.Vendor.Sourceror.parse_string!() |> is_qualified_call()
      true

      iex> "foo.bar()" |> Capstone.Vendor.Sourceror.parse_string!() |> is_qualified_call()
      true

      iex> "node()" |> Capstone.Vendor.Sourceror.parse_string!() |> is_qualified_call()
      false

      iex> "%{}" |> Capstone.Vendor.Sourceror.parse_string!() |> is_qualified_call()
      false

      iex> "@attr" |> Capstone.Vendor.Sourceror.parse_string!() |> is_qualified_call()
      false

      iex> "1" |> Capstone.Vendor.Sourceror.parse_string!() |> is_qualified_call()
      false

      iex> "(1; 2)" |> Capstone.Vendor.Sourceror.parse_string!() |> is_qualified_call()
      false

      iex> "Macro.Env" |> Capstone.Vendor.Sourceror.parse_string!() |> is_qualified_call()
      false
  """
  ...
  ## Examples
      ...
      iex> "node" |> Capstone.Vendor.Sourceror.parse_string!() |> is_identifier()
      true

      iex> "node()" |> Capstone.Vendor.Sourceror.parse_string!() |> is_identifier()
      false

      iex> "1" |> Capstone.Vendor.Sourceror.parse_string!() |> is_identifier()
      false
  """
