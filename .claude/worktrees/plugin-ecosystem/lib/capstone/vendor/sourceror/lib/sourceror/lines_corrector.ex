defmodule Capstone.Vendor.Sourceror.LinesCorrector do
  @moduledoc false

  import Capstone.Vendor.Sourceror, only: [get_line: 1, correct_lines: 2]

  import Capstone.Vendor.Sourceror.Identifier, only: [is_binary_op: 1]
  ...
  * If a node has trailing comments, its end_of_expression and end line
  ...
  defp do_post_correct({_, meta, _} = quoted, state) do
    ...
    last_line = Capstone.Vendor.Sourceror.get_end_line(quoted, last_line)
