...
defmodule Capstone.Vendor.Sourceror.Code.Tuple do
  @moduledoc """
  ...
  def tuple?(item) do
    item = Capstone.Vendor.Sourceror.Code.Common.maybe_move_to_single_child_block(item)
  ...
  def elem_equals?(zipper, elem, value) do
    case tuple_elem(zipper, elem) do
      {:ok, zipper} ->
        Capstone.Vendor.Sourceror.Code.Common.nodes_equal?(zipper, value)
