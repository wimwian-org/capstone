defmodule Capstone.Vendor.Sourceror do
  ...
  alias Capstone.Vendor.Sourceror.TraversalState
  ...
  @code_module (if Version.match?(System.version(), "~> 1.13") do
                  ...
                  Capstone.Vendor.Sourceror.Code
                end)
  ...
  defmacro string_to_quoted!(string, opts) do
    ...
    quote bind_quoted: [
      ...
      |> Capstone.Vendor.Sourceror.map_literal_fix(map_literal_fix?)
    end
  end
  ...
  def parse_string(source, opts \\ []) do
    ...
    with {:ok, quoted, comments} <- string_to_quoted(source, opts ++ to_quoted_opts()) do
      {:ok, Capstone.Vendor.Sourceror.Comments.merge_comments(quoted, comments)}
    end
  end
  ...
  def parse_string!(source, opts \\ []) do
    ...
    Capstone.Vendor.Sourceror.Comments.merge_comments(quoted, comments)
  end
  ...
  ## Examples
      ...
      ...>
      ...> :ok
      ...> "\"" |> Capstone.Vendor.Sourceror.parse_expression()
  ...
  def to_algebra(quoted, opts \\ []) do
    ...
    {quoted, comments} = Capstone.Vendor.Sourceror.Comments.extract_comments(quoted, extract_comments_opts)
  ...
  Returns the metadata of the given node.
      ...
      iex> Capstone.Vendor.Sourceror.get_meta({:foo, [line: 5], []})
      [line: 5]
  """
  ...
  Returns the arguments of the node.
      ...
      iex> Capstone.Vendor.Sourceror.get_args({:foo, [], [{:__block__, [], [:ok]}]})
      [{:__block__, [], [:ok]}]
  """
  ...
  Updates the arguments for the given node.
      ...
      iex> updater = fn args -> Enum.map(args, &Capstone.Vendor.Sourceror.correct_lines(&1, 2)) end
      iex> Capstone.Vendor.Sourceror.update_args(node, updater)
  ...
  coalesced with a value that is not known upfront.
      ...
      iex> Capstone.Vendor.Sourceror.get_line({:foo, [line: 5], []})
      5

      iex> Capstone.Vendor.Sourceror.get_line({:foo, [], []}, 3)
      3
  """
  ...
  coalesced with a value that is not known upfront.
      ...
      iex> Capstone.Vendor.Sourceror.get_column({:foo, [column: 5], []})
      5

      iex> Capstone.Vendor.Sourceror.get_column({:foo, [], []}, 3)
      3
  """
  ...
  value is returned(defaults to 1).
      ...
      iex> Capstone.Vendor.Sourceror.get_end_line({:foo, [end: [line: 4]], []})
      4

      iex> Capstone.Vendor.Sourceror.get_end_line({:foo, [closing: [line: 2]], []})
      2

      iex> Capstone.Vendor.Sourceror.get_end_line({:foo, [end_of_expression: [line: 5]], []})
      5

      iex> Capstone.Vendor.Sourceror.get_end_line({:foo, [closing: [line: 2], end: [line: 4]], []})
      4
      ...
      ...>   Bar
      ...> }
      ...> "\"" |> Capstone.Vendor.Sourceror.parse_string!() |> Capstone.Vendor.Sourceror.get_end_line()
      3
  """
  ...
  in the node. For accurate start positions, use `get_range/1`.
      ...
      iex> quoted = Capstone.Vendor.Sourceror.parse_string!(" :foo")
      iex> Capstone.Vendor.Sourceror.get_start_position(quoted)
      [line: 1, column: 2]

      iex> quoted = Capstone.Vendor.Sourceror.parse_string!("\\n\\nfoo()")
      iex> Capstone.Vendor.Sourceror.get_start_position(quoted)
      [line: 3, column: 1]

      iex> quoted = Capstone.Vendor.Sourceror.parse_string!("Foo.{Bar}")
      iex> Capstone.Vendor.Sourceror.get_start_position(quoted)
      [line: 1, column: 1]
  ...
  in the node. For accurate end positions, use `get_range/1`.
      ...
      ...>   B
      ...> }
      ...> "\"" |>  Capstone.Vendor.Sourceror.parse_string!()
      iex> Capstone.Vendor.Sourceror.get_end_position(quoted)
      [line: 3, column: 1]
  ...
  This function is most useful when used after `Capstone.Vendor.Sourceror.parse_string/2`,
  before any kind of modification to the AST.
      ...
      ...> end
      ...> "\"" |> Capstone.Vendor.Sourceror.parse_string!()
      iex> Capstone.Vendor.Sourceror.get_range(quoted)
      %Capstone.Vendor.Sourceror.Range{start: [line: 1, column: 1], end: [line: 3, column: 4]}
      ...
      ...> "\"" |> Capstone.Vendor.Sourceror.parse_string!()
      iex> Capstone.Vendor.Sourceror.get_range(quoted)
      %Capstone.Vendor.Sourceror.Range{start: [line: 1, column: 1], end: [line: 3, column: 2]}
  ...
  ...> "\""
  ...> |> Capstone.Vendor.Sourceror.parse_string!()
  ...> |> Capstone.Vendor.Sourceror.get_range(include_comments: true)
  %Capstone.Vendor.Sourceror.Range{start: [line: 1, column: 1], end: [line: 2, column: 11]}
  ```
  """
  @spec get_range(Macro.t()) :: Capstone.Vendor.Sourceror.Range.t() | nil
  def get_range(quoted, opts \\ []) do
    Capstone.Vendor.Sourceror.Range.get_range(quoted, opts)
  end
  ...
  ## Examples
      ...
      ...> end
      ...> "\""
      iex> patch = %Capstone.Vendor.Sourceror.Patch{
      ...>   change: "unless allowed? do\\n  raise \\"Not allowed!\\"\\nend",
      ...>   range: %Capstone.Vendor.Sourceror.Range{start: [line: 1, column: 1], end: [line: 3, column: 4]}
      ...> }
  ...
  range will be given as an argument:
      ...
      ...>   range: %Capstone.Vendor.Sourceror.Range{start: [line: 1, column: 7], end: [line: 1, column: 13]}
      ...> }
      iex> Capstone.Vendor.Sourceror.patch_string(original, [patch])
      ~S"\""
      hello :WORLD
  ...
  the indentation level at the start of the range:
      ...
      iex> patch = %Capstone.Vendor.Sourceror.Patch{
      ...>   change: "bar do\\n  :replacement\\nend",
      ...>   range: %Capstone.Vendor.Sourceror.Range{start: [line: 2, column: 9], end: [line: 4, column: 6]}
      ...> }
      iex> Capstone.Vendor.Sourceror.patch_string(original, [patch])
      ~S"\""
      outer do
  ...
  your patch:
      ...
      "\""
  """
  @spec patch_string(String.t(), [Capstone.Vendor.Sourceror.Patch.t()]) :: String.t()
