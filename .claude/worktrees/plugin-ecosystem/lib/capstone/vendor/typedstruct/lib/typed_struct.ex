defmodule Capstone.Vendor.TypedStruct do
  ...
  defmacro __using__(_) do
    quote do
      import Capstone.Vendor.TypedStruct,
  ...
  defmacro typedstruct(opts \\ [], do: block) do
    ast = Capstone.Vendor.TypedStruct.__typedstruct__(block, opts)
  ...
  defmacro typedrecord(name, opts \\ [], do: block) when is_list(opts) do
    ast = Capstone.Vendor.TypedStruct.__typedrecord__(name, block, opts)
  ...
  def __typedstruct__(block, opts) do
    quote do
      ...
      Capstone.Vendor.TypedStruct.__struct_type__(@ts_types, unquote(opts))
...
#        @spec new(map()) :: unquote(__MODULE__).t
  ...
  def __typedrecord__(name, block, opts) do
    ...
    quote do
      ...
      Capstone.Vendor.TypedStruct.__record_type__(
        @ts_types,
        unquote(opts),
        unquote(name),
        unquote(tag)
  ...
  defmacro __struct_type__(types, opts) do
    case Capstone.Vendor.TypedStruct.__visibility__(opts) do
      :public ->
  ...
  `Capstone.Vendor.TypedStruct.Plugin`. To use a third-party plugin, please refer directly to
  its documentation.
  """
  ...
  defmacro field(name, type, opts \\ []) do
    quote bind_quoted: [name: name, type: Macro.escape(type), opts: opts] do
      Capstone.Vendor.TypedStruct.__field__(name, type, opts, __ENV__)
    end
  end
