defmodule Capstone.Vendor.Vex.Validators.Acceptance do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Capstone.Vendor.Vex.Validators.Acceptance.validate(1, true)
      :ok
      iex> Capstone.Vendor.Vex.Validators.Acceptance.validate(nil, true)
      {:error, "must be accepted"}
      iex> Capstone.Vendor.Vex.Validators.Acceptance.validate(nil, message: "must be accepted!")
      {:error, "must be accepted!"}
      iex> Capstone.Vendor.Vex.Validators.Acceptance.validate(1, [as: "yes"])
      {:error, ~S(must be accepted with `"yes"`)}
      iex> Capstone.Vendor.Vex.Validators.Acceptance.validate("verily", [as: "verily"])
      :ok
  ...
  Custom error messages (in EEx format), provided as :message, can use the following values:
      ...
      iex> Capstone.Vendor.Vex.Validators.Acceptance.__validator__(:message_fields)
      [value: "The bad value"]

  An example:

      iex> Capstone.Vendor.Vex.Validators.Acceptance.validate(nil, message: "<%= inspect value %> doesn't count as accepted")
