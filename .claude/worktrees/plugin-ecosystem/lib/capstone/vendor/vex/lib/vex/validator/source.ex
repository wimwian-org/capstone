defprotocol Capstone.Vendor.Vex.Validator.Source do
  def lookup(source, name)
end

defimpl Capstone.Vendor.Vex.Validator.Source, for: Atom do
...
defimpl Capstone.Vendor.Vex.Validator.Source, for: List do
