defprotocol Capstone.Vendor.Vex.Extract do
...
defimpl Capstone.Vendor.Vex.Extract, for: List do
...
defimpl Capstone.Vendor.Vex.Extract, for: Map do
  def settings(map) do
    Map.get(map, :_vex)
  end
...
defmodule Capstone.Vendor.Vex.Extract.Struct do
  @moduledoc false
  defmacro for_struct do
    quote do
      defimpl Capstone.Vendor.Vex.Blank, for: __MODULE__ do
        def blank?(struct), do: struct |> Map.from_struct() |> map_size == 0
      end

      defimpl Capstone.Vendor.Vex.Extract, for: __MODULE__ do
...
defimpl Capstone.Vendor.Vex.Extract, for: Tuple do
