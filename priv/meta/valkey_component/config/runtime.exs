...
#
#     PHX_SERVER=true bin/new_api_app start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :new_api_app, NewApiAppWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :new_api_app, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :new_api_app, NewApiApp.Mailer,
